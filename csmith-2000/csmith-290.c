...
static int32_t g_8[8] = {0xEDEDB5CAL,0xEDEDB5CAL,0xEDEDB5CAL,0xEDEDB5CAL,0xEDEDB5CAL,0xEDEDB5CAL,0xEDEDB5CAL,0xEDEDB5CAL};
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    uint32_t l_6 = 0xF07B4BC6L;
    (*l_2) = 0L;
    for (g_3 = 21; (g_3 > (-4)); g_3 = safe_sub_func_int8_t_s_s(g_3, 8))
    { /* block id: 4 */
        (*g_7) ^= l_6;
    }
    return g_3;
