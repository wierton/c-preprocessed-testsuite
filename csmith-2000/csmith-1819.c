...
static int32_t g_24[1][5] = {{0x32FD2D1AL,0x32FD2D1AL,0x32FD2D1AL,0x32FD2D1AL,0x32FD2D1AL}};
static volatile uint16_t g_29[5] = {0x68CDL,0x68CDL,0x68CDL,0x68CDL,0x68CDL};
...
{ /* block id: 0 */
    ...
    int32_t *l_26 = (void*)0;
    int32_t *l_27 = &g_3;
    int32_t *l_28[1][2][7] = {{{&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3},{&l_15[0],&l_15[0],&l_15[0],&l_15[0],&l_15[0],&l_15[0],&l_15[0]}}};
    int i, j, k;
    for (i = 0; i < 3; i++)
        l_15[i] = 0xFA72C25FL;
    --g_29[4];
