...
static int32_t g_6[6] = {0x86F8C7B5L,1L,0x86F8C7B5L,0x86F8C7B5L,1L,0x86F8C7B5L};
static int32_t * volatile g_11 = &g_6[2];/* VOLATILE GLOBAL g_11 */
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        uint16_t l_10 = 0xCDE9L;
        for (g_6[2] = 0; (g_6[2] >= (-12)); g_6[2] = safe_sub_func_int64_t_s_s(g_6[2], 5))
        { /* block id: 6 */
            return l_9[4];
        }
        (*g_11) |= l_10;
