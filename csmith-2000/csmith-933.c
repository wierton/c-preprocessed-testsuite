...
static const volatile int32_t * volatile * volatile g_9 = (void*)0;/* VOLATILE GLOBAL g_9 */
static const volatile int32_t * volatile * volatile g_10[5] = {&g_2[0],&g_2[0],&g_2[0],&g_2[0],&g_2[0]};
...
{ /* block id: 0 */
    ...
    int16_t l_5 = (-5L);
    const volatile int32_t * volatile *l_11 = &g_2[0];
lbl_8:
    l_4 = g_2[0];
    (*g_6) &= l_5;
    if (l_5)
