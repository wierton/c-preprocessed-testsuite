...
static volatile int32_t g_4 = 0xFB0B0297L;/* VOLATILE GLOBAL g_4 */
static int32_t g_5 = 0xEC2DB221L;
static int32_t g_9 = 2L;
static volatile int32_t g_16 = (-1L);/* VOLATILE GLOBAL g_16 */
static volatile uint64_t g_18 = 1UL;/* VOLATILE GLOBAL g_18 */
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        ...
        int32_t *l_12 = &g_9;
        int32_t *l_13 = &g_9;
        int32_t l_14 = 0x5CC25BFCL;
        int32_t *l_15[3][1];
        int64_t l_17 = 0xE52509E71B35D569LL;
        int i, j;
        for (i = 0; i < 3; i++)
        {
            for (j = 0; j < 1; j++)
