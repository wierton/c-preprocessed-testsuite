...
static uint32_t g_9[7][1] = {{4UL},{0xE3B6F9B6L},{4UL},{0xE3B6F9B6L},{4UL},{0xE3B6F9B6L},{4UL}};
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    const int32_t l_5[9][1][9] = {{{(-8L),(-8L),(-5L),(-8L),(-8L),(-5L),(-8L),(-8L),(-5L)}},{{(-8L),(-8L),(-5L),(-8L),(-8L),(-5L),(-8L),(-8L),(-5L)}},{{(-8L),(-8L),(-5L),(-8L),(-8L),(-5L),(-8L),(-8L),(-5L)}},{{(-8L),(-8L),(-5L),(-8L),(-8L),(-5L),(-8L),(-8L),(-5L)}},{{(-8L),(-8L),(-5L),0xA8FECF79L,0xA8FECF79L,(-8L),0xA8FECF79L,0xA8FECF79L,(-8L)}},{{0xA8FECF79L,0xA8FECF79L,(-8L),0xA8FECF79L,0xA8FECF79L,(-8L),0xA8FECF79L,0xA8FECF79L,(-8L)}},{{0xA8FECF79L,0xA8FECF79L,(-8L),0xA8FECF79L,0xA8FECF79L,(-8L),0xA8FECF79L,0xA8FECF79L,(-8L)}},{{0xA8FECF79L,0xA8FECF79L,(-8L),0xA8FECF79L,0xA8FECF79L,(-8L),0xA8FECF79L,0xA8FECF79L,(-8L)}},{{0xA8FECF79L,0xA8FECF79L,(-8L),0xA8FECF79L,0xA8FECF79L,(-8L),0xA8FECF79L,0xA8FECF79L,(-8L)}}};
    uint32_t *l_7 = (void*)0;
    uint32_t *l_8 = &g_9[4][0];
    int32_t *l_10 = &g_11;
    int i, j, k;
    g_4 = ((*l_10) &= (((*l_8) &= ((safe_sub_func_uint32_t_u_u(g_4, l_5[4][0][4])) && (safe_unary_minus_func_int8_t_s((-1L))))) >= l_5[8][0][8]));
    return g_11;
}
