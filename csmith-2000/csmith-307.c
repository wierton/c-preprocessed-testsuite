...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0x3DE0369BL;
static uint16_t g_10 = 0x642EL;
static int32_t g_14 = 0x4D1B40E1L;
...
{ /* block id: 0 */
    ...
    uint16_t *l_9 = &g_10;
    (*g_13) = (((g_2 , (g_2 & (((*l_9) |= ((((safe_sub_func_int32_t_s_s(g_2, l_5)) && 0x7CL) && (+(safe_mul_func_uint16_t_u_u(0xA90CL, g_2)))) || g_2)) & (safe_mod_func_int16_t_s_s(g_2, g_2))))) , 0UL) ^ l_5);
    return g_2;
}
