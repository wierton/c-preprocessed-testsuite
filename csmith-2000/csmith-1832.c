...
static int32_t g_13[6] = {(-1L),0xD3C15D0DL,(-1L),(-1L),0xD3C15D0DL,(-1L)};
static int32_t * volatile g_12 = &g_13[0];/* VOLATILE GLOBAL g_12 */
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    for (g_4 = 0; (g_4 < 11); g_4 = safe_add_func_uint8_t_u_u(g_4, 9))
    { /* block id: 3 */
        int32_t *l_9 = &g_10;
        (*g_12) &= func_7((6UL & ((*l_9) = g_4)));
    }
    return g_13[4];
}
