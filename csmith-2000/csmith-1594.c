...
/* --- GLOBAL VARIABLES --- */
static volatile uint16_t g_2 = 0xD94BL;/* VOLATILE GLOBAL g_2 */
static volatile uint8_t g_3 = 0xD2L;/* VOLATILE GLOBAL g_3 */
static int32_t g_5 = 0L;
static union U1 g_10 = {1UL};/* VOLATILE GLOBAL g_10 */
