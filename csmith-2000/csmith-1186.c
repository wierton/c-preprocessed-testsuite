...
static union U0 g_6 = {0x1F90EF307D7C1188LL};/* VOLATILE GLOBAL g_6 */
static union U0 g_9 = {-1L};/* VOLATILE GLOBAL g_9 */
...
static union U0  func_1(void)
{ /* block id: 0 */
    uint32_t l_2[6] = {0xD03248C6L,0UL,0xD03248C6L,0xD03248C6L,0UL,0xD03248C6L};
    int i;
    for (g_5 = 0; (g_5 <= 5); g_5 += 1)
    { /* block id: 3 */
        return g_6;
    }
    g_3 = (0xE32CF415D7249AAELL && (safe_lshift_func_uint8_t_u_s(255UL, 3)));
    return g_9;
}
