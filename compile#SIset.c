...
int r0, r1; int *p0, *p1;
{r0 = (*((int *)(11111111 & ~(__alignof__ (int) - 1)))); }
...
int r0, r1; int *p0, *p1;
{r0 = (((int *)(11111111 & ~(__alignof__ (int) - 1)))[x1]); }
...
int r0, r1; int *p0, *p1;
{(*p0) = (*((int *)(11111111 & ~(__alignof__ (int) - 1)))); }
...
int r0, r1; int *p0, *p1;
{(*p0) = (((int *)(11111111 & ~(__alignof__ (int) - 1)))[x1]); }
...
int r0, r1; int *p0, *p1;
{(*((int *)10000000)) = ((int)(int)&glob1); }

adr0adr1_set (r0, r1, x0, x1, p0, p1)
int r0, r1; int *p0, *p1;
{(*((int *)10000000)) = (*((int *)(11111111 & ~(__alignof__ (int) - 1)))); }

adr0adrreg1_set (r0, r1, x0, x1, p0, p1)
int r0, r1; int *p0, *p1;
{(*((int *)10000000)) = (p1[1111111/4]); }

adr0adrx1_set (r0, r1, x0, x1, p0, p1)
int r0, r1; int *p0, *p1;
{(*((int *)10000000)) = (((int *)(11111111 & ~(__alignof__ (int) - 1)))[x1]); }
...
int r0, r1; int *p0, *p1;
{(p0[10000000]) = ((int)(int)&glob1); }

adrreg0adr1_set (r0, r1, x0, x1, p0, p1)
int r0, r1; int *p0, *p1;
{(p0[10000000]) = (*((int *)(11111111 & ~(__alignof__ (int) - 1)))); }
...
int r0, r1; int *p0, *p1;
{(p0[10000000]) = (((int *)(11111111 & ~(__alignof__ (int) - 1)))[x1]); }
...
int r0, r1; int *p0, *p1;
{(((int *)10000000)[x0]) = ((int)(int)&glob1); }

adrx0adr1_set (r0, r1, x0, x1, p0, p1)
int r0, r1; int *p0, *p1;
{(((int *)10000000)[x0]) = (*((int *)(11111111 & ~(__alignof__ (int) - 1)))); }

adrx0adrreg1_set (r0, r1, x0, x1, p0, p1)
int r0, r1; int *p0, *p1;
{(((int *)10000000)[x0]) = (p1[1111111/4]); }

adrx0adrx1_set (r0, r1, x0, x1, p0, p1)
int r0, r1; int *p0, *p1;
{(((int *)10000000)[x0]) = (((int *)(11111111 & ~(__alignof__ (int) - 1)))[x1]); }

adrx0regx1_set (r0, r1, x0, x1, p0, p1)
int r0, r1; int *p0, *p1;
{(((int *)10000000)[x0]) = (p1[x1]); }
...
int r0, r1; int *p0, *p1;
{(p0[x0]) = (*((int *)(11111111 & ~(__alignof__ (int) - 1)))); }
...
int r0, r1; int *p0, *p1;
{(p0[x0]) = (((int *)(11111111 & ~(__alignof__ (int) - 1)))[x1]); }
