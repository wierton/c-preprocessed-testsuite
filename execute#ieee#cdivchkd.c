...
int match (double _Complex c, double _Complex z)
{
  ...
  if (__builtin_fabs (rz) > ((double)2.22507385850720138309023271733240406e-308L))
    {
    ...
    {
      rerr = __builtin_fabs (rz - rc) / ((double)2.22507385850720138309023271733240406e-308L);
    }

  if (__builtin_fabs (iz) > ((double)2.22507385850720138309023271733240406e-308L))
    {
    ...
    {
      ierr = __builtin_fabs (iz - ic) / ((double)2.22507385850720138309023271733240406e-308L);
    }
  rmax = __builtin_fmax(rerr, ierr);
  biterr = 0;
  if ( rmax != 0.0)
    {
      biterr = ilogb (rmax) + 53 + 1;
    }
