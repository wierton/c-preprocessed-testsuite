...
short r0, r1; short *p0, *p1;
{r0 = (*((short *)(11111111 & ~(__alignof__ (short) - 1)))); }
...
short r0, r1; short *p0, *p1;
{r0 = (((short *)(11111111 & ~(__alignof__ (short) - 1)))[x1]); }
...
short r0, r1; short *p0, *p1;
{(*p0) = (*((short *)(11111111 & ~(__alignof__ (short) - 1)))); }
...
short r0, r1; short *p0, *p1;
{(*p0) = (((short *)(11111111 & ~(__alignof__ (short) - 1)))[x1]); }
...
short r0, r1; short *p0, *p1;
{(*((short *)10000000)) = ((short)(int)&glob1); }

adr0adr1_set (r0, r1, x0, x1, p0, p1)
short r0, r1; short *p0, *p1;
{(*((short *)10000000)) = (*((short *)(11111111 & ~(__alignof__ (short) - 1)))); }

adr0adrreg1_set (r0, r1, x0, x1, p0, p1)
short r0, r1; short *p0, *p1;
{(*((short *)10000000)) = (p1[1111111/4]); }

adr0adrx1_set (r0, r1, x0, x1, p0, p1)
short r0, r1; short *p0, *p1;
{(*((short *)10000000)) = (((short *)(11111111 & ~(__alignof__ (short) - 1)))[x1]); }

adr0regx1_set (r0, r1, x0, x1, p0, p1)
short r0, r1; short *p0, *p1;
{(*((short *)10000000)) = (p1[x1]); }
...
short r0, r1; short *p0, *p1;
{(p0[10000000]) = ((short)(int)&glob1); }

adrreg0adr1_set (r0, r1, x0, x1, p0, p1)
short r0, r1; short *p0, *p1;
{(p0[10000000]) = (*((short *)(11111111 & ~(__alignof__ (short) - 1)))); }
...
short r0, r1; short *p0, *p1;
{(p0[10000000]) = (((short *)(11111111 & ~(__alignof__ (short) - 1)))[x1]); }
...
short r0, r1; short *p0, *p1;
{(((short *)10000000)[x0]) = r1; }

adrx0indreg1_set (r0, r1, x0, x1, p0, p1)
short r0, r1; short *p0, *p1;
{(((short *)10000000)[x0]) = (*p1); }

adrx0imm1_set (r0, r1, x0, x1, p0, p1)
short r0, r1; short *p0, *p1;
{(((short *)10000000)[x0]) = 33; }

adrx0limm1_set (r0, r1, x0, x1, p0, p1)
short r0, r1; short *p0, *p1;
{(((short *)10000000)[x0]) = ((short)(int)&glob1); }

adrx0adr1_set (r0, r1, x0, x1, p0, p1)
short r0, r1; short *p0, *p1;
{(((short *)10000000)[x0]) = (*((short *)(11111111 & ~(__alignof__ (short) - 1)))); }

adrx0adrreg1_set (r0, r1, x0, x1, p0, p1)
short r0, r1; short *p0, *p1;
{(((short *)10000000)[x0]) = (p1[1111111/4]); }

adrx0adrx1_set (r0, r1, x0, x1, p0, p1)
short r0, r1; short *p0, *p1;
{(((short *)10000000)[x0]) = (((short *)(11111111 & ~(__alignof__ (short) - 1)))[x1]); }

adrx0regx1_set (r0, r1, x0, x1, p0, p1)
short r0, r1; short *p0, *p1;
{(((short *)10000000)[x0]) = (p1[x1]); }
...
short r0, r1; short *p0, *p1;
{(p0[x0]) = ((short)(int)&glob1); }

regx0adr1_set (r0, r1, x0, x1, p0, p1)
short r0, r1; short *p0, *p1;
{(p0[x0]) = (*((short *)(11111111 & ~(__alignof__ (short) - 1)))); }
...
short r0, r1; short *p0, *p1;
{(p0[x0]) = (((short *)(11111111 & ~(__alignof__ (short) - 1)))[x1]); }
